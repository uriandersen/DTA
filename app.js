...
window.addEventListener('DOMContentLoaded',()=>{
 ...
 send.onclick=async()=>{
  ...
  activeController=new AbortController();send.textContent='Stop';send.classList.add('stop');
  ...
  finally{activeController=null;send.textContent='Send';send.classList.remove('stop');c.scrollTop=c.scrollHeight}
 };
