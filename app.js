...
window.addEventListener('DOMContentLoaded',()=>{
 ...
 renderSaved();
 const send=$('.send'), ta=$('textarea'); let activeController=null;
 send.onclick=async()=>{
  ...
  activeController=new AbortController();send.textContent='■';send.setAttribute('aria-label','Stop');send.classList.add('stop');
  ...
  finally{activeController=null;send.textContent='→';send.setAttribute('aria-label','Send');send.classList.remove('stop');c.scrollTop=c.scrollHeight}
 };
