...
- Ved digitale/interface-prototyper skal de valgte 3–5 skærme/states stå i selve PROTOTYPEBRIEFEN. Beskriv dem på konceptniveau: hvilket afgørende øjeblik i oplevelsen de repræsenterer, hvad testpersonen skal møde, og den essentielle handling/valg. Undgå alle små felter, statusser, branches, komponenter og tekniske states. Briefen skal fungere som et lille design sprint: læringsmål → 3–5 afgørende oplevelsesøjeblikke → build → test.
